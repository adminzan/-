...
<script type="text/javascript" src="/srcipt/jquery-1.7.2.js"></script>
    ...
    <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-3">
            <div class="am-input-group am-input-group-sm">
                <form action="/TourManagerServlet?operate=5" method="post">
                    ...
                    <td>
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                                ...
                                <a href="/TourManagerServlet?operate=2&id=<%=tour.getId()%>" class="am-btn am-btn-default am-btn-xs am-text-secondary btn"><span class="am-icon-pencil-square-o"></span> 删除</a>
                            </div>
                        </div>
                    </td>
                    </tr>
                    ...
                    <div class="am-fr">
                        <ul class="am-pagination">
                            <li <%--class="am-disabled"--%>>
                                <a href="/TourManagerServlet?operate=5&name=<%=session.getAttribute("likename")%>&pageNum=1">首页</a>
                            </li>
                            <li class="am-pagination">
                                <a href="/TourManagerServlet?operate=5&name=<%=session.getAttribute("likename")%>&pageNum=${Page.pageNum-1}">上一页</a>
                            </li>
                               ...
                               <%
                                ...
                                %>
                            <li>
                                <a href="/TourManagerServlet?operate=5&name=<%=session.getAttribute("likename")%>&pageNum=<%=i%>"><span style="display:inline"><%=i%></span></a>
                            </li>
                                <%
                                ...
                                --%>
                            <li>
                                <a href="/TourManagerServlet?operate=5&name=<%=session.getAttribute("likename")%>&pageNum=${Page.pageNum+1}">下一页</a>
                            </li>
                            <li>
                                <a href="/TourManagerServlet?operate=5&name=<%=session.getAttribute("likename")%>&pageNum=${Page.totalPage}">末页</a>
                            </li>

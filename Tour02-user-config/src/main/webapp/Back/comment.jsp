    ...
    <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-3">
            <div class="am-input-group am-input-group-sm">
                <form action="/CommentServlet?operate=4&pageNum" method="post">
        ...
        <div class="am-u-sm-12">
            <form class="am-form">
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <%--<td><%=tour.getId()%></td>--%>
                        <td><%=comment.getTid()%></td>
                        <td><%=comment.getuName()%></td>
                        <td><%=comment.getDate()%></td>
                        <td><%=comment.getMark()%></td>
                        <%
                            if(comment.getContent().length()>10) {
                                sub=comment.getContent().substring(0, 10);
                            }else{
                                sub=comment.getContent();
                            }
                        %>
                        <td><%=sub%></td>
                    ...
                    <td>
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                                ...
                                <a href="/CommentServlet?operate=3&id=<%=comment.getId()%>" class="am-btn am-btn-default am-btn-xs am-text-secondary delbtn"><span class="am-icon-pencil-square-o"></span> 删除</a>
                            </div>
                        </div>
                    </td>
                    </tr>
                ...
                <%--<div class="am-cf">
                    ...
                    <div class="am-fr">
                        <ul class="am-pagination">
                            <li &lt;%&ndash;class="am-disabled"&ndash;%&gt;>
                            ...
                            <li class="am-pagination">
                               ...
                               <%
                                ...
                                for (int i=1;i<=commentPage.getTotalPage();i++){
                            ...
                            <li>
                                ...
                                &lt;%&ndash;<c:forEach begin="1"  end="${page.totalPage}" var="index">
                                    <c:choose>

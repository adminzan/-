    ...
    <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-3">
            <div class="am-input-group am-input-group-sm">
                ...
                <form action="/UserManagerServlet?operate=5&pageNum=1" method="post" class="from_2">
                    按年龄查询：
                ...
                <div class="am-cf">
                    ...
                    <div class="am-fr">
                        <ul class="am-paginations">
                            <li>
                                <a href="/UserManagerServlet?operate=4&username=<%=session.getAttribute("likename")%>&pageNum=1">首页</a>
                            </li>
                            <li class="li_1">
                                <a href="/UserManagerServlet?operate=4&username=<%=session.getAttribute("likename")%>&pageNum=<%=userUserPage.getPageNum()+1%>">下一页</a>
                            </li>
                            <li class="li_2">
                                <%
                                ...
                                <a href="/UserManagerServlet?operate=4&username=<%=session.getAttribute("likename")%>&pageNum=<%=i%>">
                                    [<%=i%>]
                                </a>
                            ...
                            <%--</li>--%>
                            <li class="li_3">
                                <a href="/UserManagerServlet?operate=4&username=<%=session.getAttribute("likename")%>&pageNum=<%=userUserPage.getPageNum()-1%>">上一页</a>

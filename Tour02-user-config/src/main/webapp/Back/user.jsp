    ...
    <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-3">
            <div class="am-input-group am-input-group-sm">
                <form action="/UserManagerServlet?operate=4&pageNum" class="from_1" method="post">
                <input type="text" class="input_2"  name="username" placeholder="请输入姓名查询" required/>
                    <input  type="submit" value="搜索" >
                </form>

                <form action="/UserManagerServlet?operate=5&pageNum" method="post" class="from_2">
                    按年龄查询：
                ...
                <div class="am-cf">
                    ...
                    <div class="am-fr">
                        <ul class="am-paginations">
                            <li>
                                <a href="/UserManagerServlet?operate=6&pageNum=1">首页</a>
                            </li>
                            <li class="li_1">
                                <a href="/UserManagerServlet?operate=6&pageNum=<%=userUserPage.getPageNum()+1%>">下一页</a>
                            </li>
                            <li class="li_2">
                                <%
                                ...
                                <a href="/UserManagerServlet?operate=6&pageNum=<%=i%>">
                                    [<%=i%>]
                                </a>
                            ...
                            <%--</li>--%>
                            <li class="li_3">
                                <a href="/UserManagerServlet?operate=6&pageNum=<%=userUserPage.getPageNum()-1%>">上一页</a>

                            </li>
                            <li>
                                <a href="/UserManagerServlet?operate=6&pageNum=<%=userUserPage.getTotalPage()%>">末页</a>

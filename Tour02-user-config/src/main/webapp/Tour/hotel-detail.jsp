...
<div id="page" class="theia-exception">
    ...
    <main>
        <section class="hero_in hotels_detail">
            <div class="wrapper">
                <div class="container">
                    <h1 class="fadeInUp"><span></span>酒店详情页</h1>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <section id="description">
                            ...
                            <hr>
                            <%
                                List<RoomType> roomTypeList = (List<RoomType>) session.getAttribute("roomTypeList");
                                for (RoomType roomType:roomTypeList){
                            %>
                            <div class="room_type first">
                                <div class="row">
                                    <div class="col-md-4">
                                        <img src="img/hotel/<%=roomType.getPicPath()%>" class="img-fluid" alt="">
                                    </div>
                                    <div class="col-md-8">
                                        <h4><%=roomType.getName()%></h4>
                                        <p><%=roomType.getDescribe()%></p>
                                        <ul class="hotel_facilities">
                                            <li><img src="img/hotel_facilites_icon_2.svg" alt="">单人床</li>
                                            <li><img src="img/hotel_facilites_icon_4.svg" alt="">免费wifi</li>
                                            <li><img src="img/hotel_facilites_icon_5.svg" alt="">淋浴</li>
                                            <li><img src="img/hotel_facilites_icon_7.svg" alt="">中央空调</li>
                            ...
                            <div id="instagram-feed-hotel" class="clearfix">
                                <%
                                    String[] pictures2 = hotel.getPicPath2().split("\\*");
                                    for(String picture2:pictures2){
                                %>

                                <img src="img/hotel_detail/<%=picture2%>" style="width: 100%">
                    ...
                    <aside class="col-lg-4" id="sidebar">
                        <div class="box_detail booking">
                            <div class="price">
                                <span><%=hotel.getPrice()%> <small>人</small></span>
                                <div class="score"><span>评价<em>350 回复</em></span><strong><%=hotel.getMark()%></strong></div>
                            </div>
                            ...
                            <form action="/ToPayIndex?operate=2&price=<%=hotel.getPrice()%>&id=<%=hotel.getId()%>&userName=<%=username%>&uid=<%=uid%>" method="post">

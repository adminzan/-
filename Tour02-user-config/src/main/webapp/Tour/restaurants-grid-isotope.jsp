        ...
        $(function () {
                    ...
                    success:function (result) {
                        ...
                        $(result).each(function () {
                            names+="<div class=\"row\">\n" +
                                ...
                                "                            <a href=\"restaurant-detail.html\"><img src=\"img/restaurant/"+this.picpath+"\" class=\"img-fluid\" alt=\"\" width=\"800\" height=\"533\"><div class=\"read_more\"><span>细节</span></div></a>\n" +
                                "                            <small>"+this.city+"</small>\n" +
                                "                        </figure>\n" +
                                "                        <div class=\"wrapper\">\n" +
                                "                            <h3><a href=\"restaurant-detail.html\">"+this.name+"</a></h3>\n" +
                                "                            <p>"+this.restaurantdescribe.substr(0,10)+"</p>\n" +
                                "                            <span class=\"price\">起价 <strong>"+this.price+"</strong> /每人</span>\n" +
                                "                        </div>\n" +
                                "                        <ul>\n" +
                                "                            <li><i class=\"ti-eye\"></i> 164 浏览</li>\n" +
                                "                            <li><div class=\"score\"><span>Superb<em>"+this.reviews+"</em></span><strong>"+this.mark+"</strong></div></li>\n" +
                                "                        </ul>\n" +
                                "                    </div>\n" +
                                "                </div>\n" +
                                "            </div>";
                        })
                        $(".isotope-wrapper").empty().append(names);
                    }
                })
            })
            ...
            $.ajax({
                ...
                success:function (result) {
                    var str="";
                    $(result).each(function () {
                        str+= "<div class=\"col-xl-4 col-lg-6 col-md-6 isotope-item popular\">\n" +
                              "                        <div class=\"box_grid\">\n" +
                              "                            <figure>\n" +
                              "                                <a href=\"#0\" class=\"wish_bt\"></a>\n" +
                              "                                <a href=\"restaurant-detail.html\"><img src=\"img/"+this.picpath+"\" class=\"img-fluid\" alt=\"\" width=\"800\" height=\"533\"><div class=\"read_more\"><span>Read more</span></div></a>\n" +
                              "                                <small>"+this.city+"</small>\n" +
                              "                            </figure>\n" +
                              "                            <div class=\"wrapper\">\n" +
                              "                                <h3><a href=\"restaurant-detail.html\">"+this.name+"</a></h3>\n" +
                              "                                <p>"+this.restaurantdescribe+"</p>\n" +

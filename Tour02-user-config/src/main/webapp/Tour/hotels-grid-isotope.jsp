...
<div id="page">
    ...
    <main>
        ...
        <section class="hero_in hotels">
            <div class="wrapper">
                <div class="container">
                    <h1 class="fadeInUp"><span></span>途遇酒店，最好的酒店</h1>
                </div>
            </div>
        </section>
        <!--/hero_in-->
                ...
                <div class="row">
                    ...
                    for (Hotel hotel:hotelList){
                        ...
                        if(hotel.getDescribe().length()>10) {
                            hotelDetail = hotel.getDescribe().substring(0,10);
                        }else{
                            hotelDetail = hotel.getDescribe();
                        }
                    %>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 isotope-item popular">
                        <div class="box_grid">
                            <figure>
                                ...
                                <a href="/HotelDetailServlet?id=<%=hotel.getId()%>"><img src="img/hotel/<%=hotel.getPicPath()%>" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
                                <small><%=hotel.getCity()%></small>
                            </figure>
                            <div class="wrapper">
                                <div class="cat_star"><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i></div>
                                <h3><a href="/HotelDetailServlet?id=<%=hotel.getId()%>"><%=hotel.getName()%></a></h3>
                                <p><%=hotelDetail%></p>
                                <span class="price">价格 <strong><%=hotel.getPrice()%></strong> /人</span>
                            </div>
                            <ul>
                                <li><i class="ti-eye"></i> 164 浏览</li>
                                <li><div class="score"><span>Superb<em>350 Reviews</em></span><strong><%=hotel.getMark()%></strong></div></li>
                            </ul>
                        </div>
                    </div>

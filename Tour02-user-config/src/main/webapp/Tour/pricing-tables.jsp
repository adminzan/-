...
<div id="page">
    ...
    <main>
        <section class="hero_in general">
            <div class="wrapper">
                <div class="container">
                    <h1 class="fadeInUp"><span></span>会员价格表</h1>
                </div>
            </div>
        </section>
        <!--/hero_in-->
                ...
                <ul class="pricing-list bounce-invert">
                    <li>
                        <ul class="pricing-wrapper">
                            ...
                            <form action="/ToPayIndex2?operate=1&uid=<%=session.getAttribute("uid")%>" method="get">
                    ...
                    <li class="popular">
                        <ul class="pricing-wrapper">
                            <li data-type="monthly" class="is-visible">
                                ...
                                <!-- /pricing-body -->
                                <footer class="pricing-footer">
                                    <a class="select-plan" href="/ToPayIndex2?operate=3&uid=<%=session.getAttribute("uid")%>">选择</a>
                                </footer>
                            </li>
                            <li data-type="yearly" class="is-hidden">
                                <header class="pricing-header">
                                ...
                                <!-- /pricing-body -->
                                <footer class="pricing-footer">
                                    <a class="select-plan" href="/ToPayIndex2?operate=4&uid=<%=session.getAttribute("uid")%>">选择</a>
                                </footer>
                            </li>
                        </ul>
                        <!-- /cd-pricing-wrapper -->

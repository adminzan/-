            ...
            <div class="wrapper">
                <div class="container">
                    <div class="bs-wizard clearfix">
                        ...
                        <div class="bs-wizard-step disabled">
                            <div class="text-center bs-wizard-stepnum"><a style="color: white;"><a href="/OrderServlet?operate=3&pageNum=1">美食</a></a></div>
                            <div class="progress">
                                <div class="progress-bar"></div>
                            </div>
                    ...
                    <%--<div class="col-lg-8" style="border: 1px solid green;width: 1200px">
                        <div class="box_cart" style="border: 1px solid yellow;">--%>
                            <table class="table table-striped cart-list"<%-- border="1px"--%>>
                                ...
                                <tbody>
                                <%
                                    PageUtil<HotelOrder> hotelOrderPageUtil = (PageUtil<HotelOrder>)session.getAttribute("hotelOrderPageUtil");
                                    List<HotelOrder> list = hotelOrderPageUtil.getData();
                                    for (HotelOrder hotelOrder:list){
                                %>
                                <tr>
                                    <td>
                                        <div class="thumb_cart">
                                            <img src="img/hotel/<%=hotelOrder.getPicPath()%>" alt="Image">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td colspan="2">
                                        <a href="/OrderServlet?operate=2&pageNum=1">首页</a>


                                        <%
                                            if(hotelOrderPageUtil.getPageNum()!=1){
                                        %>
                                        <a href="/OrderServlet?operate=2&pageNum=<%=hotelOrderPageUtil.getPageNum()-1%>">上一页</a>
                                        <%
                                            }
                                        %>
                                        ...
                                        <%
                                            for (int i = 1;i<=hotelOrderPageUtil.getTotalPage();i++){
                                                if (i==hotelOrderPageUtil.getPageNum()){
                                        %>

                                        <a href="/OrderServlet?operate=2&pageNum=<%=i %>">
                                            <span>[<%=i%>]</span>
                                        </a>
                                        ...
                                        <%
                                            if(hotelOrderPageUtil.getPageNum()!=hotelOrderPageUtil.getTotalPage()){
                                        %>
                                        <a href="/OrderServlet?operate=2&pageNum=<%=hotelOrderPageUtil.getPageNum()+1%>">下一页</a>
                                        <%
                                            }
                                        %>

                                        <a href="/OrderServlet?operate=2&pageNum=<%=hotelOrderPageUtil.getTotalPage()%>">末页</a>
                            ...
                            <div class="cart-options clearfix">
                                <div class="float-left">
                                    <%--<div class="apply-coupon">
                                        ...
                                        <div class="form-group">
                                            <a href="/OrderServlet?operate=2&pageNum=1" class="btn_1 outline">旅店</a>
                                        </div>

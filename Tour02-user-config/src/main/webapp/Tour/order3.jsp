...
<%@ page import="cn.kgc.entity.RestaurantOrder" %><%--
            ...
            <div class="wrapper">
                <div class="container">
                    <div class="bs-wizard clearfix">
                        ...
                        <div class="bs-wizard-step disabled">
                            <div class="text-center bs-wizard-stepnum"><a href="/OrderServlet?operate=2&pageNum=1">美食</a></div>
                            <div class="progress">
                                <div class="progress-bar"></div>
                            </div>
                    ...
                    <%--<div class="col-lg-8" style="border: 1px solid green;width: 1200px">
                        <div class="box_cart" style="border: 1px solid yellow;">--%>
                            <table class="table table-striped cart-list"<%-- border="1px"--%>>
                                ...
                                <tbody>
                                <%
                                    PageUtil<RestaurantOrder> restaurantOrderPageUtil = (PageUtil<RestaurantOrder>)session.getAttribute("restaurantOrderPageUtil");
                                    List<RestaurantOrder> list = restaurantOrderPageUtil.getData();
                                    for (RestaurantOrder restaurantOrder:list){
                                %>
                                <tr>
                                    <td>
                                        <div class="thumb_cart">
                                            <img src="img/restaurant/<%=restaurantOrder.getPicPath()%>" alt="Image">
                                        </div>
                                        <span class="item_cart"><%=restaurantOrder.getName()%></span>
                                    </td>
                                    <td>
                                        <%=restaurantOrder.getUserName()%>
                                    </td>
                                    <td>
                                        成人：<%=restaurantOrder.getAdult()%><br>孩子：<%=restaurantOrder.getChild()%>
                                    </td>
                                    <td>
                                        <strong><%=restaurantOrder.getPrice()%></strong>
                                    </td>
                                    <td>
                                        <strong><%=restaurantOrder.getComeDate()%></strong>
                                    </td>
                                    <td>
                                        <strong></strong>
                                    </td>
                                    <td class="options" style="width:5%; text-align:center;">
                                        <a href="/OrderServlet?operate=12&id=<%=restaurantOrder.getId()%>"><i class="icon-trash"></i></a>
                                    </td>
                                </tr>
                                <%
                                    }
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td colspan="3">
                                        <a href="/OrderServlet?operate=3&pageNum=1">首页</a><%--<%=tourOrderPageUtil.getPageNum()%>--%>
                                        <%
                                            if(restaurantOrderPageUtil.getPageNum()!=1){
                                        %>
                                        <a href="/OrderServlet?operate=3&pageNum=<%=restaurantOrderPageUtil.getPageNum()-1%>">上一页</a>
                                        <%
                                            }
                                        %>
                                        ...
                                        <%
                                            for (int i = 1;i<=restaurantOrderPageUtil.getTotalPage();i++){
                                                if(i==restaurantOrderPageUtil.getPageNum()){
                                        %>

                                        <a href="/OrderServlet?operate=3&pageNum=<%=i %>">
                                            <span>[<%=i%>]</span>
                                        </a>
                                        ...
                                        <%
                                            if(restaurantOrderPageUtil.getPageNum()!=restaurantOrderPageUtil.getTotalPage()){
                                        %>
                                        <a href="/OrderServlet?operate=3&pageNum=<%=restaurantOrderPageUtil.getPageNum()+1%>">下一页</a>
                                        <%
                                            }
                                        %>


                                        <a href="/OrderServlet?operate=3&pageNum=<%=restaurantOrderPageUtil.getTotalPage()%>">末页</a>
